...
public class NewOrderSingleEncoder implements Encoder
{
    ...
    private static final int largeFieldHeaderLength = 6;
    private static final byte[] largeFieldHeader = new byte[] {50, 50, 48, 48, 48, (byte) '='};
...
public static class UnderlyingsGroupEncoder
{
    ...
    private final MutableDirectBuffer largeField = new UnsafeBuffer();

    private int largeFieldOffset = 0;

    private int largeFieldLength = 0;

    /* LargeField = 22000 */
    public NewOrderSingleEncoder largeField(final DirectBuffer value, final int offset, final int length)
    {
        largeField.wrap(value);
        largeFieldOffset = offset;
        largeFieldLength = length;
        return this;
    }

    /* LargeField = 22000 */
    public NewOrderSingleEncoder largeField(final DirectBuffer value, final int length)
    {
        return largeField(value, 0, length);
    }

    /* LargeField = 22000 */
    public NewOrderSingleEncoder largeField(final DirectBuffer value)
    {
        return largeField(value, 0, value.capacity());
    }

    /* LargeField = 22000 */
    public NewOrderSingleEncoder largeField(final byte[] value, final int offset, final int length)
    {
        largeField.wrap(value);
        largeFieldOffset = offset;
        largeFieldLength = length;
    ...
    /* LargeField = 22000 */
    public NewOrderSingleEncoder largeFieldAsCopy(final byte[] value, final int offset, final int length)
    {
        copyInto(largeField, value, offset, length);
        largeFieldOffset = offset;
        largeFieldLength = length;
        return this;
    }
    ...
    /* LargeField = 22000 */
    public NewOrderSingleEncoder largeField(final byte[] value, final int length)
    {
        return largeField(value, 0, length);
    }

    /* LargeField = 22000 */
    public NewOrderSingleEncoder largeField(final byte[] value)
    {
        return largeField(value, 0, value.length);
    }

    /* LargeField = 22000 */
    public boolean hasLargeField()
    {
        return largeFieldLength > 0;
    }

    /* LargeField = 22000 */
    public MutableDirectBuffer largeField()
    {
        return largeField;
    }

    /* LargeField = 22000 */
    public String largeFieldAsString()
    {
        return largeField.getStringWithoutLengthAscii(largeFieldOffset, largeFieldLength);
    }

    /* LargeField = 22000 */
    public NewOrderSingleEncoder largeField(final CharSequence value)
    {
        toBytes(value, largeField);
        largeFieldOffset = 0;
        largeFieldLength = value.length();
        return this;
    }

    /* LargeField = 22000 */
    public NewOrderSingleEncoder largeField(final AsciiSequenceView value)
    {
        final DirectBuffer buffer = value.buffer();
        if (buffer != null)
        {
            largeField.wrap(buffer);
            largeFieldOffset = value.offset();
            largeFieldLength = value.length();
        }
        return this;
    }
    ...
    /* LargeField = 22000 */
    public NewOrderSingleEncoder largeField(final char[] value)
    {
        return largeField(value, 0, value.length);
    }

    /* LargeField = 22000 */
    public NewOrderSingleEncoder largeField(final char[] value, final int length)
    {
        return largeField(value, 0, length);
    }

    /* LargeField = 22000 */
    public NewOrderSingleEncoder largeField(final char[] value, final int offset, final int length)
    {
        toBytes(value, largeField, offset, length);
        largeFieldOffset = 0;
        largeFieldLength = length;
        return this;
    }
    ...
    public long encode(final MutableAsciiBuffer buffer, final int offset)
    {
        ...
        if (largeFieldLength > 0)
        {
            buffer.putBytes(position, largeFieldHeader, 0, largeFieldHeaderLength);
            position += largeFieldHeaderLength;
            buffer.putBytes(position, largeField, largeFieldOffset, largeFieldLength);
            position += largeFieldLength;
            buffer.putSeparator(position);
            position++;
        }
    ...
    builder.append("\n");
        ...
        {
            indent(builder, level);
            builder.append("\"LargeField\": \"");
            appendBuffer(builder, largeField, largeFieldOffset, largeFieldLength);
            builder.append("\",\n");
        }
        indent(builder, level - 1);
        builder.append("}");
    ...
    public NewOrderSingleEncoder copyTo(final NewOrderSingleEncoder encoder)
    {
        ...
        if (hasLargeField())
        {
            encoder.largeFieldAsCopy(largeField.byteArray(), 0, largeFieldLength);
        }
        return encoder;
    }
