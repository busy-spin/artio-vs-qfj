...
public static class UnderlyingSecurityAltIDGroupEncoder
{
    ...
    private int underlyingRepoCollateralSecurityType;
    ...
    public UnderlyingInstrumentEncoder underlyingRepoCollateralSecurityType(int value)
    {
        underlyingRepoCollateralSecurityType = value;
    ...
    public int encode(final MutableAsciiBuffer buffer, final int offset)
    {
        ...
        if (hasUnderlyingRepoCollateralSecurityType)
        {
            ...
            position += buffer.putIntAscii(position, underlyingRepoCollateralSecurityType);
            buffer.putSeparator(position);
            position++;
        }
    ...
    public UnderlyingInstrumentEncoder copyTo(final UnderlyingInstrumentEncoder encoder)
    {
        ...
        if (hasUnderlyingRepoCollateralSecurityType())
        {
            encoder.underlyingRepoCollateralSecurityType(this.underlyingRepoCollateralSecurityType());
        }
