...
public class CollateralInquiryDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, InstrumentLegDecoder, TrdRegTimestampsDecoder, SpreadOrBenchmarkCurveDataDecoder, StipulationsDecoder, SettlInstructionsDataDecoder, MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(514);
