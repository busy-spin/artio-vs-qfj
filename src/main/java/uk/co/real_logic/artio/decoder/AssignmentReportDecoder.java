...
public class AssignmentReportDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, InstrumentLegDecoder, PositionQtyDecoder, PositionAmountDataDecoder, MessageDecoder
{
    public final IntHashSet REQUIRED_FIELDS = new IntHashSet(30);
    ...
    private final IntHashSet missingRequiredFields = new IntHashSet(30);
    ...
    public final IntHashSet messageFields = new IntHashSet(432);
