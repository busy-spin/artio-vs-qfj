...
public class NewOrderSingleDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, StipulationsDecoder, OrderQtyDataDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, CommissionDataDecoder, PegInstructionsDecoder, DiscretionInstructionsDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.LARGE_FIELD);
        }
    }
...

    {
        ...
        messageFields.add(Constants.LARGE_FIELD);
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return MoneyLaunderingStatus.NULL_VAL;
    ...
    private char[] largeField = new char[1];

    private boolean hasLargeField;

    /* LargeField = 22000 */
    public char[] largeField()
    {
        if (!hasLargeField)
        {
            throw new IllegalArgumentException("No value for optional field: LargeField");
        }
    ...
    {
        return hasLargeField;
    }


    private int largeFieldOffset;

    private int largeFieldLength;

    /* LargeField = 22000 */
    public int largeFieldLength()
    {
        if (!hasLargeField)
        {
            throw new IllegalArgumentException("No value for optional field: LargeField");
        ...
        return largeFieldLength;
    }

    /* LargeField = 22000 */
    public String largeFieldAsString()
    {
        return hasLargeField ? new String(largeField, 0, largeFieldLength) : null;
    }

    /* LargeField = 22000 */
    public AsciiSequenceView largeField(final AsciiSequenceView view)
    {
        if (!hasLargeField)
        {
            throw new IllegalArgumentException("No value for optional field: LargeField");
        ...
        return view.wrap(buffer, largeFieldOffset, largeFieldLength);
    }


    private final CharArrayWrapper largeFieldWrapper = new CharArrayWrapper();
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.LARGE_FIELD:
                hasLargeField = true;
                largeField = buffer.getChars(largeField, valueOffset, valueLength);
                largeFieldOffset = valueOffset;
                largeFieldLength = valueLength;
                break;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasLargeField())
        {
            ...
            builder.append(this.largeField(), 0, largeFieldLength());
            builder.append("\",\n");
        }
        indent(builder, level - 1);
        builder.append("}");
    ...
    public NewOrderSingleEncoder toEncoder(final NewOrderSingleEncoder encoder)
    {
        ...
        if (hasLargeField())
        {
            encoder.largeField(this.largeField(), 0, largeFieldLength());
        }
        return encoder;
    }
