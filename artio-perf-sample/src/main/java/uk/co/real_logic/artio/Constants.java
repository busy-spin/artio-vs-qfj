...
public class Constants
{
    ...
    public static final int I_O_IID = 23;
    ...
    public static final int CUSTOM_TEST_FIELD = 5000;
    ...
    public static final int LARGE_FIELD = 22000;
    ...
    public static final IntHashSet ALL_FIELDS = new IntHashSet(1944);
    static
    {
        ...
        ALL_FIELDS.add(Constants.I_O_IID);
        ...
        ALL_FIELDS.add(Constants.CUSTOM_TEST_FIELD);
        ...
        ALL_FIELDS.add(Constants.LARGE_FIELD);
