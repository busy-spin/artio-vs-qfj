...
public static class SecurityAltIDGroupEncoder
{
    ...
    private int repoCollateralSecurityType;
    ...
    public InstrumentEncoder repoCollateralSecurityType(int value)
    {
        repoCollateralSecurityType = value;
...
public static class EventsGroupEncoder
{
    ...
    public int encode(final MutableAsciiBuffer buffer, final int offset)
    {
        ...
        if (hasRepoCollateralSecurityType)
        {
            ...
            position += buffer.putIntAscii(position, repoCollateralSecurityType);
            buffer.putSeparator(position);
            position++;
        }
    ...
    public InstrumentEncoder copyTo(final InstrumentEncoder encoder)
    {
        ...
        if (hasRepoCollateralSecurityType())
        {
            encoder.repoCollateralSecurityType(this.repoCollateralSecurityType());
        }
