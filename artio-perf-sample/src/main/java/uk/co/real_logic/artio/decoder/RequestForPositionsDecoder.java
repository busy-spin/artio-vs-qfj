...
public class RequestForPositionsDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(114);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(114);
    ...
    public final IntHashSet messageFields = new IntHashSet(400);
