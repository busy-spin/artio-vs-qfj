...
public class CollateralInquiryAckDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, InstrumentLegDecoder, MessageDecoder
{
