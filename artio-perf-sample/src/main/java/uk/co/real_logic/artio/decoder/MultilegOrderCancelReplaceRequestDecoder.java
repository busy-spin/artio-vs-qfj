...
public class MultilegOrderCancelReplaceRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, OrderQtyDataDecoder, CommissionDataDecoder, PegInstructionsDecoder, DiscretionInstructionsDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(252);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(252);
    ...
    public final IntHashSet messageFields = new IntHashSet(626);
