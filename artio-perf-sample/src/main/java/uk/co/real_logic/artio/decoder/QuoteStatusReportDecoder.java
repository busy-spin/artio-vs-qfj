...
public class QuoteStatusReportDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, OrderQtyDataDecoder, StipulationsDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(238);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(238);
    ...
    public final IntHashSet messageFields = new IntHashSet(556);
