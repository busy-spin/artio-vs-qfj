...
public class QuoteRequestDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(530);
...
public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, FinancingDetailsDecoder, OrderQtyDataDecoder, StipulationsDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, PartiesDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(184);
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder, NestedPartiesDecoder, LegBenchmarkCurveDataDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(102);
