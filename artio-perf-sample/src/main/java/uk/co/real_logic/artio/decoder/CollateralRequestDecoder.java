...
public class CollateralRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, InstrumentLegDecoder, TrdRegTimestampsDecoder, SpreadOrBenchmarkCurveDataDecoder, StipulationsDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(262);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.NO_LEGS);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(262);
    ...
    public final IntHashSet messageFields = new IntHashSet(494);
...
public class TradesGroupDecoder extends CommonDecoderImpl
{
 ...
 return QtyType.NULL_VAL;
    ...
    private int noLegs = MISSING_INT;
    ...
    public int noLegs()
    {
        if (!hasNoLegs)
        {
            throw new IllegalArgumentException("No value for optional field: NoLegs");
        }

        return noLegs;
    }

    public boolean hasNoLegs()
    {
        return hasNoLegs;
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.NO_LEGS:
                hasNoLegs = true;
                noLegs = getInt(buffer, valueOffset, endOfField, 555, CODEC_VALIDATION_ENABLED);
                break;
