...
public class OrderMassCancelReportEncoder implements Encoder
{
    ...
    private char massCancelRejectReason;
    ...
    public OrderMassCancelReportEncoder massCancelRejectReason(char value)
    {
...
public static class AffectedOrdersGroupEncoder
{
    ...
    public long encode(final MutableAsciiBuffer buffer, final int offset)
    {
        ...
        if (hasMassCancelRejectReason)
        {
            ...
            position += buffer.putCharAscii(position, massCancelRejectReason);
            buffer.putSeparator(position);
            position++;
        }
